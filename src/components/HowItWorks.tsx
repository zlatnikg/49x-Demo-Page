  ...
  return (
    <div 
      className={cn(
        ...
        isActive 
          ? "bg-white dark:bg-black shadow-elegant border-pulse-200" 
          : "bg-white/50 dark:bg-black/50 hover:bg-white/80 dark:hover:bg-black/80 border-transparent"
      )}
      onClick={onClick}
    >
...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 bg-white dark:bg-black relative" id="how-it-works" ref={sectionRef}>
      {/* Background decorative elements */}
      <div className="absolute -top-20 right-0 w-72 h-72 bg-pulse-50 rounded-full opacity-60 blur-3xl -z-10"></div>
      <div className="absolute bottom-0 left-10 w-64 h-64 bg-gray-50 dark:bg-black rounded-full opacity-70 blur-3xl -z-10"></div>
