...
const CTA = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 bg-black relative" id="get-access" ref={ctaRef}>
      ...
      <div className="section-container relative z-10 opacity-0 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-8 md:p-10 lg:p-14 text-center overflow-hidden relative">
          ...
          <div className="absolute bottom-0 left-0 w-24 sm:w-32 h-24 sm:h-32 bg-black/50 rounded-full -translate-x-1/2 translate-y-1/2 blur-2xl"></div>
